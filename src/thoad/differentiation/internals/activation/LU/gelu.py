...
from thoad.differentiation.internals.utils.derivate import gelu_derivate
...
class GeluXBackward0(ContractiveFunction):
    ...
    def _extract_context(self) -> None:
        # extract info
        saved_approximate: str = getattr(self._grad_fn, "_saved_approximate")
    ...
    def _compute_internal_0(self, order: int) -> IDData:
        ...
        derivative: Tensor = gelu_derivate(tensor=input, order=order)
