...
from thoad.differentiation.internals.utils.derivate import tanh_derivate
from thoad.typing import Shape, Indep, Notation, IDData


class TanhXBackward0(ContractiveFunction):
    ...
    def _compute_internal_0(self, order: int) -> IDData:
        ...
        derivative: Tensor = tanh_derivate(tensor=output, order=order)
