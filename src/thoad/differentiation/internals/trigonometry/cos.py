...
from thoad.differentiation.internals.utils.derivate import cos_derivate
...
class CosXBackward0(ContractiveFunction):
    ...
    def _compute_internal_0(self, order: int) -> IDData:
        ...
        derivative: Tensor = cos_derivate(tensor=input, order=order)
