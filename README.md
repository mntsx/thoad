...
- **High Performance**: thoad hessian comp time scales exponentially better than [torch.autograd](https://docs.pytorch.org/docs/stable/autograd.html), remaining closer to [jax.jet](https://docs.jax.dev/en/latest/jax.experimental.jet.html)'s performance.
